...
export default function LearnHero() {
  return (
    <div className="bg-indigo-700 py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="mt-6 max-w-lg mx-auto flex items-center bg-white rounded-lg p-1">
            <input
              type="text"
              placeholder="Search tutorials, courses, topics..."
              className="block w-full px-4 py-2 text-gray-900 placeholder-gray-500 focus:outline-none"
            />
